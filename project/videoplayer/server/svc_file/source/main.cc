...
DEFINE_int32(listen_port, 9001, "文件子服务监听端口");
...
DEFINE_string(service_addr, "192.168.65.128:9001", "服务地址");
...
DEFINE_string(fdfs_tracker_host, "192.168.65.128:22122", "fdfs服务器地址");
